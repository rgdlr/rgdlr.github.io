                ...
                <div className={style.leftSection}>
                    <div className={style.innerContent}>
                        ...
                        <p className={style.subheading}>
                            Looks like the page you were looking for is no
                            longer here.
                        </p>
                        <br />
                        <hr />
